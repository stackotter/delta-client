...
public enum ProtocolVersion: Int {
  ...
  // Don't include the v for snapshot versions because it's not necessary and it's less obvious that it's not part of the version's name because snapshot names include letters.
  case v1_16_1 = 736
}
